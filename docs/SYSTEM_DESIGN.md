# System Design — AI-Powered Personalized Learning OS (LearnOS)

> Architecture and design reference for LearnOS. Built by **Vishal Prasad** ([AIwithVishal](https://github.com/Vishal-ml-ds)).
