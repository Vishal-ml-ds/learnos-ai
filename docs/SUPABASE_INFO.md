...
- **Secret** (for signature verification): `<YOUR-KEY>`
...
### Backend to Database
- **Connection**: `postgresql+asyncpg://postgres:<YOUR-PASSWORD>@db.<YOUR-PROJECT-REF>.supabase.co:5432/postgres`
...
3. Select project: `<YOUR-PROJECT-REF>`
